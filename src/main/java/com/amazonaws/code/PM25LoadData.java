...
public class PM25LoadData {
	...
	public static void main(String[] args) throws Exception {
		...
		URL url = new URL("https://api.openaq.org/v1/latest?country=CN&&parameter=pm25&&limit=1500");
		...
		while (iter2.hasNext()) {
			...
			pm25.add(currentNode2.path("value").asInt());
			String hour = String.valueOf(new Date().getHours() + 1);
			final Map<String, Object> infoMap = new HashMap<String, Object>();
			infoMap.put(hour, pm25.get(0));
			...
			if (table.getItem("location", location) != null) {
				UpdateItemSpec updateItemSpec = new UpdateItemSpec().withPrimaryKey("location", location)
						...
						.withValueMap(new ValueMap().withNumber(":val", pm25.get(0)))
