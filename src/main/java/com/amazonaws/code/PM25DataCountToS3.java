...
public class PM25DataCountToS3 {
	...
	public static void main(String[] args) throws Exception {
		...
		ScanSpec scanSpec = new ScanSpec().withProjectionExpression("#location, Info")
				.withNameMap(new NameMap().with("#location", "location"));

		try {
			ItemCollection<ScanOutcome> items = table.scan(scanSpec);
			Iterator<Item> iterator = items.iterator();
			Item item = null;
			System.out.println("Read PM2.5 From location " + TableName + "");
			...
			System.err.println("Unable to query PM25");
